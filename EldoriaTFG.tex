...
Para esta fase hemos probado dos métodos interesantes del programa, el método referente al sonido y otro método referente a dibujar por pantalla elementos.
Las pruebas del codigo se han realizado con una clase llamada MainTest, que contiene el siguiente codigo: \\
\begin{lstlisting}
    @Test
    ...
    public void testPlayMusic() throws AWTException {
        ...
        assertTrue(gamePanel.musica.isMusicPlaying(), La musica no esta reproduciendose correctamente);
        ...
        assertFalse(gamePanel.musica.isMusicPlaying(), La musica no se detuvo correctamente);
    }
\end{lstlisting}
Debido al tiempo que quedaba en la fase final del desarrollo no hemos podido realizar las pruebas unitarias que nos gustaría, con la calidad que nos gustaría también, por lo que al menos,
hemos probado dos métodos que se suelen usar bastante a la hora del funcionamiento del programa.
